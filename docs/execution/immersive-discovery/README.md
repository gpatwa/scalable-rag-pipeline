...
Current checkpoint: **IMD-052, IMD-054, and IMD-056 complete**.
IMD-001 through IMD-056 and IMD-059 through IMD-060 are merged and validated
except IMD-055 and IMD-057/058. The next packetized wave is IMD-055 and
IMD-061;
...
- [IMD-055](IMD-055-monitoring-gates.md) — offline drift and regression gates
- [IMD-061](IMD-061-home-endpoint.md) — personalized home endpoint
